...
int32 GEnableGMPLogging = 0;
FAutoConsoleVariableRef CVar_EnableGMPListeningLog(TEXT("GMP.EnableListeningLog"), GEnableGMPLogging, TEXT(""));

namespace GMP
{
	bool FMessageHub::ShouldWarningNoListeners()
	{
		return GEnableGMPLogging > 0;
	};
